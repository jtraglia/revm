...
## [0.5.1](https://github.com/jtraglia/revm/compare/revme-v0.5.0...revme-v0.5.1) - 2024-06-07

### Other
- skip tests with storage check and return status ([#1452](https://github.com/jtraglia/revm/pull/1452))
